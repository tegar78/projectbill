...
<body class="bg-404" onload="JavaScript:AutoRefresh(60000);">
        ...
        <div class="dpd-20">
            <a href="/">
                <svg height='50px' width='60px' fill="#000000" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" version="1.1" style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;" viewBox="0 0 333 333" x="0px" y="0px" fill-rule="evenodd" clip-rule="evenodd">
                    ...
                    <g>
                        <g>
                            <img class="mb-3" style=" display: block;margin-left: auto;margin-right: auto; width:150px" src="<?= base_url('assets/images/') ?><?= $company['logo'] ?>" alt="">
                        </g>
                    </g>
                </svg>
            </a>
        </div>
        <div>&copy; <?= date('Y'); ?> <?= $company['company_name']; ?></div>
    </section>
