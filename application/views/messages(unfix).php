...
<?php endif; ?>
<?php if ($this->session->flashdata('success-sendsms')) : ?>
    <script>
        Swal.fire({
            icon: 'success',
            html: '<?= $this->session->flashdata('success-sendsms'); ?>',
            showConfirmButton: true,
        })
    </script>
<?php endif; ?>
<?php if ($this->session->flashdata('error-sendsms')) : ?>
    <script>
        Swal.fire({
            icon: 'error',
            html: '<?= $this->session->flashdata('error-sendsms'); ?>',
            showConfirmButton: true,
        })
    </script>
<?php endif; ?>
