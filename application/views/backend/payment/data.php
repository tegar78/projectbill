                ...
                <div class="col-lg-12">
                    <div class="card-body">
                        ...
                        <div class="" id="duitku" style="display: <?= $pg['vendor'] == 'Duitku' ? 'block' : 'none'; ?>">
                            ...
                            <?php } ?>
                            <?php
                            if (!empty($response['paymentFee']) && is_array($response['paymentFee'])) {
                        ...
                        <div class="" id="tripay" style="display: <?= $pg['vendor'] == 'Tripay' ? 'block' : 'none'; ?>">
                            ...
                            if (isset($responseData['success']) && ($responseData['success'] === true || $responseData['success'] === 'true') && !empty($responseData['data']) && is_array($responseData['data'])) {
                                ...
                                $msg = isset($responseData['message']) ? htmlspecialchars($responseData['message']) : 'API Key Tripay belum valid atau belum diisi.';
                                echo '<div class="alert alert-warning p-2 small mb-2"><i class="fas fa-exclamation-triangle mr-1"></i> ' . $msg . '</div>';
                            }
                            ?>
                            <br>
