        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="lat" name="lat" class="form-control" value="<?= $odc['latitude'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="long" name="long" class="form-control" value="<?= $odc['longitude'] ?>">
...
<script>
    ...
    var lat = "<?= $odc['latitude'] ?>";

    var long = "<?= $odc['longitude'] ?>";
