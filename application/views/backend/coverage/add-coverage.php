<?php $coverage = isset($coverage) && is_array($coverage) ? $coverage : []; ?>
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <input type="hidden" name="coverage_id" id="coverage_id" class="form-control" autocapitalize="off" value="<?= isset($coverage['coverage_id']) ? $coverage['coverage_id'] : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" id="address" class="form-control" autocapitalize="off" value="<?= isset($coverage['address']) ? $coverage['address'] : '' ?>">
                </div>

                <div class="form-group">
                    <label for="comment">Keterangan</label>
                    <input type="text" name="comment" id="comment" class="form-control" autocapitalize="off" autocomplete="off" value="<?= isset($coverage['comment']) ? $coverage['comment'] : '' ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="lat" name="lat" class="form-control" value="<?= isset($coverage['latitude']) ? $coverage['latitude'] : '' ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="long">long</label>
                    <input type="text" id="long" name="long" class="form-control" value="<?= isset($coverage['longitude']) ? $coverage['longitude'] : '' ?>" readonly>
                </div>
