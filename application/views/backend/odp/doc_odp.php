...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Data Document <?= $odp->code_odp ?></h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $doc = $this->db->get_where('odp_doc', ['odp_id' => $odp->id_odp])->result() ?>
                    <?php $no = 1;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('odp/adddoc') ?>
                <div class="form-group">
                    <label for="name">Code odp</label>
                    <input type="hidden" name="odp_id" value="<?= $odp->id_odp ?>" class="form-control" required>
                    <input type="text" id="name" name="name" value="<?= $odp->code_odp ?>" class="form-control" required readonly>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Document <?= $odp->code_odp; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="modal-body">
                    <?php echo form_open_multipart('odp/editdoc') ?>
                    <div class="form-group">
                        <label for="name">Nama odp</label>
                        <input type="hidden" name="odp_id" value="<?= $odp->id_odp ?>" class="form-control" required>
...
<div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Hapus Document <?= $odp->name; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('odp/deletedoc') ?>
                <input type="hidden" id="id-delete" name="id" value="<?= $data->id_odp ?>" class="form-control">
                <input type="hidden" name="odp_id" value="<?= $odp->id_odp ?>" class="form-control">
                Apakah yakin akan hapus document odp <?= $odp->code_odp; ?></span> ?
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
