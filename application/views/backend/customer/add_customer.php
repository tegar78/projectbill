    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4 nm-card">
            <div class="card-header py-3 nm-card-header">
                <h6 class="m-0 font-weight-bold" style="color: var(--nm-text-main);"><i class="fas fa-user-plus mr-2" style="color: var(--nm-brand);"></i> Tambah Pelanggan</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <div class="form-group">
                            ...
                            <select name="coverage" id="coverage" class="form-control" onchange="selectcoverage(this);">
                                ...
                                <?php if (isset($customer) && is_object($customer) && isset($customer->coverage) && $customer->coverage != 0) { ?>
                                    <?php $datacoverage = $this->db->get_where('coverage', ['coverage_id' => $customer->coverage])->row_array(); ?>
                                    <option value="<?= $customer->coverage ?>"><?= isset($datacoverage['code_area']) ? $datacoverage['code_area'] : '' ?> - <?= isset($datacoverage['c_name']) ? $datacoverage['c_name'] : '' ?></option>
                                <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <span id="generatenoservices" class="input-group-text nm-btn nm-btn-primary" style="cursor: pointer;"><i class="fas fa-magic mr-1"></i> Generate</span>
                                </div>
                            </div>
                ...
                <?php if (isset($package) && is_array($package) && isset($package['coverage_package']) && $package['coverage_package'] == 1) { ?>
                    <div class="form-group">
                        <div class="row">
                ...
                <?php } ?>
                <?php if (!isset($package) || !is_array($package) || !isset($package['coverage_package']) || $package['coverage_package'] == 0) { ?>
                    <div class="form-group">
                ...
                <?php if (!empty($wa) && isset($wa['is_active']) && $wa['is_active'] == 1) { ?>
                ...
                <input type="hidden" name="vendor" id="vendor" value="<?= isset($wa['vendor']) ? $wa['vendor'] : '' ?>">
    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4 nm-card">
            <div class="card-body">
                ...
                <?php if (!empty($rt) && isset($rt['is_active']) && $rt['is_active'] == 1) { ?>
                ...
                <div class="modal-footer" style="border-top: 1px solid var(--nm-shadow-dark);">
                    <button type="reset" class="nm-btn" data-dismiss="modal"><i class="fas fa-undo mr-1"></i> Batal</button>
                    <button type="submit" class="nm-btn nm-btn-primary ml-2"><i class="fas fa-save mr-1"></i> Simpan</button>
                </div>
                <?php echo form_close() ?>
            </div>
        </div>
