...
<div class="row">
    ...
    <?php
    $totalincome = $this->income_m->getTotalIncome();
    $totalexpend = $this->expenditure_m->getTotalExpenditure(); ?>
...
?>
<div class="card shadow mb-4" id="reportglobal">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Laporan Keuangan Bulan Ini (<?= indo_month(date('m')) . ' ' . date('Y'); ?>)</h6>
    </div>
    <div class="card-body">
