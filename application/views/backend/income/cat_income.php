...
<div class="row">
    ...
    <div class="col">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">Pemasukan Per-Kategori Bulan Ini</h6>
                            ...
                            <tbody>
                                ...
                                foreach ($category as $r => $data) { ?>
                                    <tr>
                                        <td style="text-align: center"><?= $no++ ?>.</td>
                                        <td><?= $data->name ?></td>
                                        <?php $incomecategory = $this->income_m->getCategoryThisMonth($data->category_id)->result() ?>
                                        <?php $nominal = 0;
                                        foreach ($incomecategory as $c => $dataa) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('income/addcategory') ?>" method="POST">
    ...
    <div class="modal fade" id="edit<?= $data->category_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('income/editcategory') ?>" method="POST">
                        <div class="form-group">
                            <label for="name">Nama Kategori</label>
    ...
    <div class="modal fade" id="delete<?= $data->category_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('income/deletecategory') ?>" method="POST">
