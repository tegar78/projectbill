                        ...
                        <tr style="font-size:12; font-weight: 200;">
                            <th>
                                ...
                                <?php if ($data['disabled'] == 'true') { ?>
                                    <a href="<?= site_url('mikrotik/enablehotspotuser/' . $id) ?>" data-username="<?= $data['name'] ?>" style="color: grey;"> <i class="fa fa-lock" title="Enable User <?= $data['name']; ?>"></i></a> <?php } ?>
                                <?php if ($data['disabled'] != 'true') { ?> <a href="<?= site_url('mikrotik/disablehotspotuser/' . $id) ?>" data-username="<?= $data['name'] ?>" style="color: grey;"> <i class="fa fa-unlock" title="Disable User <?= $data['name']; ?>"></i></a> <?php } ?>
                                <a href="<?= site_url('mikrotik/delHotspotUser/' . $id) ?>" id="username" data-username="<?= $data['name'] ?>" style="color: red;"><i class="fa fa-trash"></i></a>
                            </th>
                            <th><?= $data['name']; ?></th>
...
<div class="modal fade" id="addModal" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <form action="<?= site_url('mikrotik/addHotspotUser') ?>" method="post">
