    ...
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pppoecount ?></div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <a href="<?= site_url('mikrotik/pppoeactive') ?>"" style=" text-decoration: none;">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Active</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pppoeactive; ?></div>
                            </div>
                            <div class="col-auto">
                                <i class="fas  fa-2x text-gray-300"></i>
                            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <a href="<?= site_url('mikrotik/pppoedisable') ?>" style="text-decoration: none;">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Isolir</div>
                                <div class="h6 mb-0 font-weight-bold text-gray-600">Disable User : <?= $pppoedisable; ?></div>
                                <div class="h6 mb-0 font-weight-bold text-gray-600">Profile Expired : <?= $pppoeexpired; ?></div>
                            </div>
                            <div class="col-auto">
                                <i class="fas  fa-2x text-gray-300"></i>
                            </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <a href="#" style="text-decoration: none;">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tidak Aktif</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pppoecount - $pppoeactive - $pppoedisable - $pppoeexpired; ?></div>
                            </div>
                            <div class="col-auto">
                                <i class="fas  fa-2x text-gray-300"></i>
                            </div>
