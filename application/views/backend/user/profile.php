        ...
        <div class="card-body">
            <div class="box box-primary">
                ...
                <div class="row d-sm-flex align-items-center justify-content-between">
                    <div class="col mb-1">
                        <a href="<?= site_url('user/changepassword') ?>" class="btn btn-primary"> Ganti Password</a>
                    </div>
                    <div class="col">
                        <a href="" data-toggle="modal" data-target="#email" class="btn btn-primary"> Ganti Email</a>
                    </div>
                    <div class="col">
