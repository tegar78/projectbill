                          ...
                          <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                  <div class="col mr-2">
                                      ...
                                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $this->help_m->getpending()->num_rows(); ?></div>
                                  </div>
                                  <div class="col-auto">
                      ...
                      <?php if ($title != 'Data Help') { ?>
                          <?php $no = 1;
                            foreach ($help as $r => $data) { 
                                $custName = !empty($data->customer_name) ? $data->customer_name : '-';
                                $typeName = !empty($data->type_name) ? $data->type_name : '-';
                                $hsName = !empty($data->hs_name) ? $data->hs_name : '-';
                                ?>
                              <tr>
                                  ...
                                  <td style="text-align: center"> <?= !empty($data->date_created) ? date('d', $data->date_created) . ' ' . indo_month(date('m', $data->date_created)) . ' ' . date('Y', $data->date_created) . '<br>' . date('H:i:s', $data->date_created) : '-' ?> </td>
                                  <td style="text-align: center">T-<?= htmlspecialchars($data->no_ticket ?? '') ?> <br>
                                      <a href="<?= site_url('help/detail/' . $data->id) ?>" class="btn btn-outline-primary">Detail</a>
                                  </td>
                                  <td style="text-align: center"><?= htmlspecialchars($custName) ?></td>
                                  <td style="text-align: center"><?= htmlspecialchars($data->no_services ?? '-') ?></td>
                                  <td><?= htmlspecialchars($typeName) ?> <br> <?= htmlspecialchars($hsName) ?> </td>
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control select2" name="no_services" id="no_services" style="width: 100%;" required onChange="selectcs(this);">
                          ...
                          <?php
                            $listcustomertiket = isset($customertiket) ? $customertiket : (isset($customeraktif) ? $customeraktif : []);
                            foreach ($listcustomertiket as $r => $cs) { ?>
