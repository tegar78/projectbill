...
<link rel="stylesheet" href="<?= base_url() ?>assets/backend/diagram.css">
...
<?php if ($package['chart'] == 0) { ?>
    <?php redirect('dashboard'); ?>
<?php } ?>
<div id="diagram_container" class="bagan"></div>

<script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
<script src="<?= base_url() ?>/assets/backend/diagram.js"></script>
...
<script>
    ...
    diagram.data.load('<?= base_url('chart/getchart') ?>');
</script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('chart/addchart') ?>" method="POST">
                                ...
                                foreach ($line as $r => $data) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center; width:50px">
                                            <a href="<?= site_url('chart/delchart/' . $data->id) ?>" onclick="return confirm('Anda yakin ?')" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                            <!-- <a href="" class="btn btn-primary"><i class="fa fa-edit"></i> <?= $data->dir; ?></a> -->
                                        </td>
