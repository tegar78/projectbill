        ...
        <div class="page">
            ...
            <div class="header">
                ...
                <div class="row">
                    ...
                    <div class="col-6 left-content">: <?= $data->address ?> </div>
                </div>
                <div class="row">
                ...
                <?php if ($data->status == 'BELUM BAYAR') {   ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 left-content">: <?= indo_date($data->inv_due_date) ?></div>
                    </div>
                    <div class="row">
                ...
                <?php if ($data->status == 'SUDAH BAYAR') {   ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 left-content">: <?= date('d M Y h:i:s', $data->date_payment) ?></div>
                    </div>
                    <div class="row">
