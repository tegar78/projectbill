...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold"> Data Tagihan Bulan <?= indo_month($this->input->post('month')) ?> <?= $this->input->post('year') ?></h6>
    </div>
    <div class="card-body">
        ...
        <div class="row mb-2 mt-2">
            ...
            <div class="col">
                <a id="btn-cetak-matrix" class="btn btn-outline-danger" style="font-size: smaller"><i class="fa fa-print"> Dot Matrix</i></a>
            </div>
            <div class="col">
                <a id="btn-cetak-small" class="btn btn-outline-danger" style="font-size: smaller"><i class="fa fa-print"> Small</i></a>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2 col-md-4 text-left">
                            ...
                            foreach ($bill as $r => $data) { ?>
                                ...
                                ">
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        $due_date_val = isset($company['due_date']) ? $company['due_date'] : '';
                                        ...
                                        $replace = array($data->name, $data->no_services, $data->month, $data->year, indo_month($data->month) . ' ' . $data->year, $due_date_val, $totaltagihan, $company_name, $sub_name, base_url(), '%0A');
                                        $subject = isset($other['thanks_wa']) ? $other['thanks_wa'] : '';
                                        $subjectunpaid = isset($other['say_wa']) ? $other['say_wa'] : '';
