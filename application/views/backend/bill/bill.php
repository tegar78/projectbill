...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <?php if ($this->session->userdata('role_id') == 1 or $role['add_bill'] == 1) { ?>
        <div class="d-flex flex-wrap gap-2">
            <a href="" id="#addModal" data-toggle="modal" data-target="#addModal" class="nm-btn nm-btn-primary mr-2 mb-2"><i class="fas fa-plus mr-1"></i> Tambah Tagihan</a>
            <a href="" id="#billGenerate" data-toggle="modal" data-target="#billGenerate" class="nm-btn nm-btn-success mr-2 mb-2"><i class="fas fa-cog mr-1"></i> Generate</a>
            <a href="" id="#export" data-toggle="modal" data-target="#export" class="nm-btn mr-2 mb-2"><i class="fas fa-file-excel mr-1 text-success"></i> Export</a>
        </div>
    <?php } ?>
</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 col-md-6">
                    <div class="form-group mb-2">
                        <label class="nm-label mb-2" for="">Area</label>
                ...
                <div class="col-lg-3 col-sm-12 col-md-6">
                    <div class="form-group mb-2">
                        <label class="nm-label mb-2" for="">Status</label>
                        <select name="status" class="form-control select2 nm-input" style="width: 100%;" id="status" onchange="getdatabill()">
    ...
    <div class="col-12 col-lg-12">
        <div class="nm-card mb-4" id="tablebill-card">
            <div class="d-flex align-items-center justify-content-between mb-3 pb-2" style="border-bottom: 1px solid var(--nm-shadow-dark);">
                <h5 class="m-0 font-weight-bold" style="color: var(--nm-text-main);"><i class="fas fa-file-invoice mr-2" style="color: var(--nm-brand);"></i> Data Tagihan Pelanggan <span id="area"></span></h5>
            </div>
