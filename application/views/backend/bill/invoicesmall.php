                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <div class="row" style="font-size: small;">
                            ...
                            <div class="col left-content">: <?= $bill['invoice'] ?></div>
                        </div>
                        <div class="row" style="font-size: small;">
                            <div class="col">No Pel</div>
                            <div class="col left-content">: <?= $bill['no_services'] ?></div>
                        </div>
                        <div class="row" style="font-size: small;">
                            <div class="col">Nama</div>
                            <div class="col left-content">: <?= $bill['name'] ?> </div>
                        </div>
                        <!-- <div class="row">
                            <div class="col">Alamat</div>
                            <div class="col left-content">: <?= $bill['address'] ?> </div>
                        </div> -->
                        <div class="row" style="font-size: small;">
                            <div class="col">Periode</div>
                            <div class="col left-content">: <?= indo_month($bill['month']) ?> <?= $bill['year'] ?></div>
                        </div>
                        ...
                        <?php if ($bill['status'] == 'BELUM BAYAR') {   ?>
                            ...
                            <div class="row" style="font-size: small;">
                                ...
                                <div class="col left-content">: <?= indo_date($bill['inv_due_date']) ?></div>
                            </div>
                            <div class="row" style="font-size: small;">
                    ...
                    <div class="col-8 verticalLine">
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><?= $bill['invoice'] ?></th>
                                    <td><?= indo_date($bill['inv_due_date']) ?></td>
