                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="row" style="font-size: small;">
                                ...
                                <div class="col left-content">: <?= $data->invoice ?></div>
                            </div>
                            <div class="row" style="font-size: small;">
                                <div class="col">No Pel</div>
                                <div class="col left-content">: <?= $data->no_services ?></div>
                            </div>
                            <div class="row" style="font-size: small;">
                                <div class="col">Nama</div>
                                <div class="col left-content">: <?= $data->name ?> </div>
                            </div>

                            <div class="row" style="font-size: small;">
                                <div class="col">Periode</div>
                                <div class="col left-content">: <?= indo_month($data->month) ?> <?= $data->year ?></div>
                            </div>
                            ...
                            <?php if ($data->status == 'BELUM BAYAR') {   ?>
                                ...
                                <div class="row" style="font-size: small;">
                                    ...
                                    <div class="col left-content">: <?= indo_date($data->inv_due_date) ?> <?= $data->year ?></div>
                                </div>
                                <div class="row" style="font-size: small;">
                                    <div class="col">Status</div>
                                    <div class="col left-content" style="color: red;">: Belum Bayar</div>
                                </div>
                            <?php } ?>
                            <br>
                            <div class="col text-center">
                            ...
                            <div class="col text-center">
                                <?php if ($data->status == 'SUDAH BAYAR') { ?>
                                    ...
                                    <span style=" font-size: 14;letter-spacing: 2px;">Pembayaran : <?= $data->metode_payment; ?></span>
                                    <br>
                                    <span style=" font-size: 14;letter-spacing: 2px;"> <?= date('d M Y h:i:s', $data->date_payment); ?></span>
                                    <br>
                        ...
                        <div class="col-8 verticalLine">
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><?= $data->invoice ?></th>
                                        <td><?= indo_date($data->inv_due_date) ?></td>
