                            ...
                            Join `invoice` ON `invoice`.`invoice` = `invoice_detail`.`invoice_id`
                               ...
                               `invoice`.`no_services` = $no_services";
                                ...
                                <?php if ($querying == Null) { ?>
                                    ...
                                    <td>
                                        <?php $coverage = $this->db->get_where('coverage', ['coverage_id' => $data->coverage])->row_array() ?>
                                        <?= $coverage['c_name']; ?>
                                    </td>
                                    <td>
                                        <input type='checkbox' class='check-item' name='noservices[]' value='<?= $data->no_services ?>'>
