...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Data Kategori Portfolio</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= base_url('master/addcategoryPortfolio') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?= $data->cat_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= base_url('master/editcategoryPortfolio') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalHapus<?= $data->cat_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= base_url('master/deletePcategory') ?>" enctype="multipart/form-data">
