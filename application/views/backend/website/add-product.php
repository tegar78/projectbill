                    ...
                    <form method="post" action="<?= base_url('product/add') ?>" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" onKeyPress="return kodeScript(event,' :abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789',this)">
