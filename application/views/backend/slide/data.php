...
<?php if ($this->session->userdata('role_id') == 1 or $role['show_slide'] == 1) { ?>
    <section class="section">
        <?php $this->view('messages') ?>
    </section>
    <?php if ($this->session->userdata('role_id') == 1 or $role['add_slide'] == 1) { ?>
                        ...
                        foreach ($slide as $r => $data) { ?>
                            <tr>
                                ...
                                <td class="text-center" width="160px">
                                    <form>
                                        <?php if ($this->session->userdata('role_id') == 1 or $role['edit_slide'] == 1) { ?>
                                            <a class="btn btn-xs btn-primary" href="#ModalEdit<?= $data->slide_id ?>" data-toggle="modal" title="Edit"><i class="fa fa-edit"> </i></a>
                                        <?php } ?>
                                        <?php if ($this->session->userdata('role_id') == 1 or $role['del_slide'] == 1) { ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= base_url('slider/add') ?>" enctype="multipart/form-data">
